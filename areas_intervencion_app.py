...
def apply_css():
    ...
    .kpi-delta-up   {{ font-size:.50rem; color:{C['green']}; margin-top:5px; }}
    .kpi-delta-down {{ font-size:.50rem; color:{C['red']};   margin-top:5px; }}
    .kpi-delta-neu  {{ font-size:.50rem; color:{C['gray']};  margin-top:5px; }}
...
def kpi_card(label: str, value: str, unit: str = "",
    ...
    delta_html = f'<p class="{delta_cls}" style="margin:4px 0 0;font-size:.50rem">{delta}</p>' if delta else ""
