...
def kpi_card(label: str, value: str, unit: str = "",
    ...
    return (
        ...
        f'<p style="font-size:.72rem;font-weight:700;text-transform:uppercase;'
        f'letter-spacing:.05em;color:{C["gray"]};margin:0 0 6px;word-break:break-word">'
        f'<span style="font-size:1.1rem;vertical-align:middle;margin-right:5px">{icon_str}</span>'
        f'{label}</p>'
        f'{subtitle_html}'
